...
/********************************
El sensor LM35 detectara temperatura ambiental en orden de mV, los datos se procesaran para obtener los grados Celsius. 
Y posteriormente se mostrará esta información en la pantalla LCD 16X2.
